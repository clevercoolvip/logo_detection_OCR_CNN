...
def upload_file(templateS):
    if request.method == 'POST':
        ...
        textarea_logo = request.form.get("textarea")
        textarea_aboutus = request.form.get("textarea2")
        textarea_contactus = request.form.get("textarea3")
        if file.filename == '':
        ...
        if file:
            ...
            MaxToken=300
            result = [textarea_logo, textarea_aboutus, textarea_contactus]
